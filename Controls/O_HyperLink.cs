...
{
	/// <summary>
	/// Descrizione di riepilogo per OraHyperLink.
	/// </summary>
	[ToolboxData("<{0}:O_HyperLink runat=server></{0}:O_HyperLink>")]
	public class O_HyperLink:System.Web.UI.WebControls.HyperLink,IOControl
	{
