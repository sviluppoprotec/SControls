...
{
	/// <summary>
	/// Descrizione di riepilogo per OraLinkButton.
	/// </summary>
	[ToolboxData("<{0}:O_LinkButton runat=server></{0}:O_LinkButton>")]
	public class O_LinkButton:System.Web.UI.WebControls.LinkButton,IOControl
	{
