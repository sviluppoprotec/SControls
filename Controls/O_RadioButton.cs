...
{
	/// <summary>
	/// Descrizione di riepilogo per OraOptionButton.
	/// </summary>
	[ToolboxData("<{0}:O_RadioButton runat=server></{0}:O_RadioButton>")]
	public class O_RadioButton:System.Web.UI.WebControls.RadioButton,IOControl
	{
