...
{
	/// <summary>
	/// Descrizione di riepilogo per OraCheckBox.
	/// </summary>
	[ToolboxData("<{0}:O_CheckBox runat=server></{0}:O_CheckBox>")]
	public class O_CheckBox:System.Web.UI.WebControls.CheckBox ,IOControl 
	{
